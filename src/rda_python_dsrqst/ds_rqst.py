...
def set_request_info():
   ...
   for i in range(ALLCNT):
      ...
      if ridx > 0:
         ...
         if pgrec:
            if 'MD' not in PgOPT.params and pgrec['specialist'] != PgOPT.params['LN'] and PgOPT.params['LN'] != PgLOG.PGLOG['COMMONUSER']:
      ...
      if record:
         ...
         if pgrec:
            ...
            elif 'MD' not in PgOPT.params and record['specialist'] != PgOPT.params['LN'] and PgOPT.params['LN'] != PgLOG.PGLOG['COMMONUSER']:
